...
$(function () {
   ...
   var rutTienApp = new Vue({
      ...
      data: {
         ...
         giaoDich: {
            MaGD: "GD",
            HoTenNguoiGoi: emptyString,
            CMND: emptyString,
            NgayCapCMND: emptyString,
            NoiCapCMND: emptyString,
            Diachi: emptyString,
            SDT: emptyString,
      ...
      methods: {
         ...
         kiemTraTaiKhoan() {
            ...
            if (!isNullOrEmptyString(this.cmnd)) {
               //Lấy khách hàng
               axios.get('http://localhost:9006/api/TaiKhoan/LayTaiKhoanTheoSoTaiKhoan?soTK=' + this.soTaiKhoan)
                  .then(response => {
