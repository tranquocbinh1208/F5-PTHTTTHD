      ...
      methods: {
         ...
         fetchData() {
            ...
            if (dayDiff > 14) {
               ...
               axios.get('http://localhost:9002/api/GiaoDichGuiTien/ThongKeGiaoDichTheoNgay?tuNgay=' + this.tuNgay + '&denNgay=' + this.denNgay)
                  .then(res => {
                     if (res.data != null) {
            ...
            axios.get('http://localhost:9002/api/GiaoDichGuiTien/ThongKeGiaoDichTheoThang?tuNgay=' + this.tuNgay + '&denNgay=' + this.denNgay)
               .then(res => {
                  if (res.data != null) {
            ...
            axios.get('http://localhost:9002/api/GiaoDichGuiTien/ThongKeGiaoDichTheoNam?tuNgay=' + this.tuNgay + '&denNgay=' + this.denNgay)
               .then(res => {
                  if (res.data != null) {
            ...
            axios.get('http://localhost:9002/api/GiaoDichGuiTien/LayGiaoDichTheoThoiGian?tuNgay=' + this.tuNgay + '&denNgay=' + this.denNgay)
               .then(res => {
                  if (res.data != null) {
                     giaoDichs = res.data
                     LoadTable()
