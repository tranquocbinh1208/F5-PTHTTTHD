      ...
      methods: {
         ...
         fetchData() {
            ...
            if (dayDiff > 14) {
               ...
               axios.get('http://localhost:9003/api/GiaoDichChuyenTien/ThongKeGiaoDichTheoNgay?tuNgay=' + this.tuNgay + '&denNgay=' + this.denNgay)
                  .then(res => {
                     if (res.data != null) {
            ...
            axios.get('http://localhost:9003/api/GiaoDichChuyenTien/ThongKeGiaoDichTheoThang?tuNgay=' + this.tuNgay + '&denNgay=' + this.denNgay)
               .then(res => {
                  if (res.data != null) {
            ...
            axios.get('http://localhost:9003/api/GiaoDichChuyenTien/ThongKeGiaoDichTheoNam?tuNgay=' + this.tuNgay + '&denNgay=' + this.denNgay)
               .then(res => {
                  if (res.data != null) {
            ...
            axios.get('http://localhost:9003/api/GiaoDichChuyenTien/LayGiaoDichTheoThoiGian?tuNgay=' + this.tuNgay + '&denNgay=' + this.denNgay)
               .then(res => {
                  if (res.data != null) {
                     giaoDichs = res.data
                     LoadTable()
